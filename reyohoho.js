...
// @grant        GM_info
// @resource     IMPORTED_CSS https://raw.githubusercontent.com/olegsvs/reyohoho-chrome-ff-ext/master/player.css
// @run-at       document-end
// ==/UserScript==
...
function mountPlayer(movieId) {
    window.open("https://olegsvs.github.io/yohoho/#" + movieId, '_blank');
}
